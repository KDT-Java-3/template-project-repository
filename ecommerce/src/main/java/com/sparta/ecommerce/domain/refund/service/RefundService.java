...
public class RefundService {
    ...
    public RefundResponse updateRefundProcess(RefundUpdateRequest dto) {
        Refund refund = refundRepository.findById(dto.getRefundId()).orElseThrow(() -> new IllegalArgumentException("환불내역이 없습니다."));
    ...
    public List<RefundResponse> readRefundByUser(Long id) {
        List<Refund> refunds = refundRepository.findByUserId(id);
