...
public class ProductController {
    ...
    public ApiResponseModel<List<ProductResDto.ProductInfo>> getFilterProductAll(@Valid @RequestBody ProductReqDto.ProductFilterDto productFilterDto) {
        return new ApiResponseModel<>(productService.getProductInfoList(productFilterDto.getFilterCategoryIdList(), productFilterDto.getMinPrice(), productFilterDto.getMaxPrice(), productFilterDto.getNameKeyWord()));
    }
